...
public interface Errors {
    ...
    DiagnosticFactory0<KtDeclarationWithBody>
            NO_RETURN_IN_FUNCTION_WITH_BLOCK_BODY = DiagnosticFactory0.create(WARNING, DECLARATION_WITH_BODY);
    DiagnosticFactory0<KtDeclarationWithBody>
    ...
    DiagnosticFactory0<PsiElement> NO_LOGICAL_OPERATOR = DiagnosticFactory0.create(WARNING);
