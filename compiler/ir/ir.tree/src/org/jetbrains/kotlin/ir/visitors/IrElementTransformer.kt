...
interface IrElementTransformer<in D> : IrElementVisitor<IrElement, D> {
    ...
    override fun visitRuleAnd(expression: IrRuleAnd, data: D) = visitRuleExpression(expression, data)
    override fun visitRuleOr(expression: IrRuleOr, data: D) = visitRuleExpression(expression, data)
    override fun visitRuleWhen(expression: IrRuleWhen, data: D) = visitRuleExpression(expression, data)
    override fun visitRuleWhile(expression: IrRuleWhile, data: D) = visitRuleExpression(expression, data)
    override fun visitRuleCut(expression: IrRuleCut, data: D) = visitRuleExpression(expression, data)
    ...
    override fun visitRuleVariable(expression: IrRuleVariable, data: D) = visitRuleExpression(expression, data)
    override fun visitRuleCall(expression: IrRuleCall, data: D) = visitRuleExpression(expression, data)
}
