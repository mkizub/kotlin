...
interface IrElementVisitor<out R, in D> {
    ...
    fun visitRuleAnd(expression: IrRuleAnd, data: D) = visitRuleExpression(expression, data)
    fun visitRuleOr(expression: IrRuleOr, data: D) = visitRuleExpression(expression, data)
    fun visitRuleLeaf(expression: IrRuleLeaf, data: D) = visitRuleExpression(expression, data)
    fun visitRuleWhen(expression: IrRuleWhen, data: D) = visitRuleExpression(expression, data)
    fun visitRuleWhile(expression: IrRuleWhile, data: D) = visitRuleExpression(expression, data)
    fun visitRuleCut(expression: IrRuleCut, data: D) = visitRuleExpression(expression, data)
